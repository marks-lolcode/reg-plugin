...
const CONFIG = {
  ...
  // Order must match hold indexes above: [regHold, artShowHold, opsHold]
  ...
  // Fields that must be non-empty before check-in can proceed (Step 14).
  ...
  //
  // NOT_PAID is the only red condition that cannot be fixed on the attendee
  // page — the attendee must visit the cashier first.
  //
